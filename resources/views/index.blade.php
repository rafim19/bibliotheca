        ...
        <div class="my-5">
            ...
            <form action="{{ route('login') }}" method="POST" class="mt-5">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Your Binusian Email" style="border-radius: 10px;" required>
                </div>
                <div class="form-group">
                  <label for="password">Password</label>
                  <input type="password" class="form-control" id="password" name="email" placeholder="Your Password" style="border-radius: 10px;" required>
                </div>
